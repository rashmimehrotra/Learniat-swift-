...
- (NSMutableDictionary *)dictionaryWithParser:(NSXMLParser *)parser
{
...
- (NSMutableDictionary *)dictionaryWithString:(NSString *)string
{
    NSData *data = [string dataUsingEncoding:NSUTF8StringEncoding];
    return [self dictionaryWithData:data];
}

- (NSMutableDictionary *)dictionaryWithFile:(NSString *)path
{	
...
{	
    ...
    else if ([node isKindOfClass:[NSMutableDictionary class]])
    {
        NSMutableDictionary *attributes = [(NSMutableDictionary *)node attributes];
...
- (void)parser:(__unused NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(__unused NSString *)namespaceURI qualifiedName:(__unused NSString *)qName attributes:(NSMutableDictionary *)attributeDict
{	
	[self endText];
...
- (NSString *)nameForNode:(NSMutableDictionary *)node inDictionary:(NSMutableDictionary *)dict
{
	if (node.nodeName)
	{
...
+ (NSMutableDictionary *)dictionaryWithXMLParser:(NSXMLParser *)parser
{
...
+ (NSMutableDictionary *)dictionaryWithXMLString:(NSString *)string
{
...
{
	NSMutableDictionary *attributes = self[XMLDictionaryAttributesKey];
	if (attributes)
	{
...
{	
    ...
    NSMutableDictionary *childNodes = [self childNodes];
...
- (NSString *)stringValueForKeyPath:(NSString *)keyPath
{
    ...
    {
        return [(NSMutableDictionary *)value innerText];
    }
    return value;
}
...
- (NSMutableDictionary *)dictionaryValueForKeyPath:(NSString *)keyPath
{
    ...
    {
        return [[NSMutableDictionary alloc] initWithDictionary:@{XMLDictionaryTextKey: value}];
    }
    return value;
}
