...
class SSStudentDataSource: NSObject, APIManagerDelegate
{
    ...
    func getMyCurrentSessionOfTeacher(Delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(Delegate)
    ...
    func getScheduleSummaryWithSessionId(sessionId:String, WithDelegate Delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(Delegate)
    ...
    func getStudentsInfoWithSessionId(sessionId:String,  withDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func SaveSeatAssignmentWithStudentsList(studentsList:String, withSeatsIdList seatIdList:String, withSessionId sessionId:String, withDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func getAllNodesWithClassId(classId:String, withSubjectId subjectId:String, withTopicId topicId:String,withType type:String, withDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func saveLessonPlan(classId:String,  withTopicIdList topicIdList:String, withDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func startSubTopicWithTopicID(topicId:String,withStudentId studentId:String,withSessionID sessionid:String, withDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func stopSubTopicWithTopicID(topicId:String,withSessionID sessionid:String, withDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func broadcastQuestionWithQuestionId(questionId:String,withSessionID sessionID:String, withDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func clearQuestionWithQuestionogId(questionLogId:String, withDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func getStudentsAswerWithAnswerId(answerId:String, withDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func getAgregateDrilDownWithOptionId(OptionId:String,WithQuestionLogId QuestionLogId:String, WithDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func sendFeedbackToStudentWithDetails(details:AnyObject, WithDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
...
//    
    ...
    func getQueryWithQueryId(QueryId:String, WithDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func replyToDoubtWithDetails(details:AnyObject, WithDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func saveSelectedVolunteers(QueryIdList:String, withAllowVolunteerList allowVolunteer:String, WithDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func EndVolunteeringSessionwithQueryId(QueryIdList:String, withMeTooList MeTooList:String, WithDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func uploadTeacherScribble(ScribbleId:String, WithDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
    ...
    func recordQuestionWithScribbleId(ScribbleId:String,withQuestionName questionName:String,WithType Type:String,withTopicId topicd:String, WithDelegate delegate:SSStudentDataSourceDelegate)
    {
        setdelegate(delegate)
