...
const static CGFloat kCustomAlertViewCornerRadius              = 0;
...
- (void)show
{
    ...
    if (parentView != NULL) {
        ...
        else
        {
            ...
            [self setFrame:CGRectMake(0, -100, 1024,1024)];
        }
...
- (UIView *)createContainerView
{
    ...
    if (_dailogContainerFrameChanged)
    {
        [dialogContainer setFrame:CGRectMake((screenSize.width - dialogSize.width) / 2, _dailogContainerHeight, dialogSize.width, dialogSize.height)];
    }
    else
    {
        [dialogContainer setFrame:CGRectMake((screenSize.width - dialogSize.width)/1.2, (screenSize.height - dialogSize.height) / 2, dialogSize.width, dialogSize.height)];
    }
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setTitleColor:[UIColor colorWithRed:0 green:174.0/255.0 blue:239.0/255.0 alpha:1.0] forState:UIControlStateNormal];
        [closeButton setTitleColor:[UIColor colorWithRed:0 green:174.0/255.0 blue:239.0/255.0 alpha:1.0] forState:UIControlStateHighlighted];
