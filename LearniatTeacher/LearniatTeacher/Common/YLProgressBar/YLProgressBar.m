 ...
 * YLProgressBar.m
 *
 * Copyright 2012 - present, Mindshift applications and solutions Private Ltd.
 *
 */
...
- (void)initializeProgressBar
{
    ...
    self.backgroundColor          = [UIColor colorWithRed:213.0/255.0 green:213.0/255.0 blue:213.0/255.0 alpha:1.0];
}
...
- (void)drawText:(CGContextRef)context withRect:(CGRect)rect
{
    ...
    if (!hasTextColor)
    {
        ...
        if (_indicatorTextDisplayMode == YLProgressBarIndicatorTextDisplayModeTrack)
        {
            backgroundColor = _trackTintColor.CGColor ?: [UIColor colorWithRed:213.0/255.0 green:213.0/255.0 blue:213.0/255.0 alpha:1.0].CGColor;
        } else
        {
