...
- (void)setup {
    ...
    _tintColor = [UIColor colorWithRed:76.0/255.0 green:217.0/255.0 blue:100.0/255.0 alpha:1.0];
    _tickColor = [UIColor whiteColor];
    
    self.progressBackgroundLayer = [CAShapeLayer layer];
    _progressBackgroundLayer.strokeColor = [UIColor colorWithRed:238.0/255.0 green:238.0/255.0 blue:238.0/255.0 alpha:1.0].CGColor;
...
- (void)setLineWidth:(CGFloat)lineWidth {
    ...
    _progressBackgroundLayer.lineWidth = _lineWidth * 2.0;
    _progressLayer.lineWidth = _lineWidth * 2.0;
    _iconLayer.lineWidth = _lineWidth;
}
