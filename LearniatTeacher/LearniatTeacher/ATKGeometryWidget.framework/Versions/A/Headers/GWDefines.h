...
typedef NS_ENUM (NSUInteger, GWFloatParameter)
{
    ...
    /**
     * The diameter of point, in millimeters.
     */
    GWFloatParameterPointDiameter,
    /**
     * The radius of the angle marker, in millimeters.
     */
    GWFloatParameterAngleMarkerRadius,
    /**
     * The difference of radius between two adjacent angle markers, in millimeters.
     */
    GWFloatParameterAngleMarkerRadiusDifference,
    /**
     * Height of the small lines representing a same lenght between two segments, in millimeters.
     */
    ...
    /**
     * Arrow size representing parallelism, in millimeters.
     */
    GWFloatParameterParallelismMarkerSize,
    /**
     * The radius of the circle representing junction, in millimeters.
     */
    GWFloatParameterJunctionMarkerSize,
    /**
