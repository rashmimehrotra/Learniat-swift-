...
#define kSPUserResizableViewInteractiveBorderSize 15
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetStrokeColorWithColor(context, [UIColor colorWithRed:0/255.0 green:160.0/255.0 blue:219.0/255.0 alpha:1.0].CGColor);
...
//    CGGradientRef gradient = CGGradientCreateWithColorComponents(baseSpace, colors, NULL,20);
//    CGColorSpaceRelease(baseSpace), baseSpace = NULL;
    ...
    for (NSInteger i = 0; i < 8; i++)
    {
        ...
        CGContextRef context = UIGraphicsGetCurrentContext();
        CGContextSetRGBStrokeColor(context, 0,160,291, 1.0);
        CGContextSetRGBFillColor(context, 0,160,219, 1.0);
